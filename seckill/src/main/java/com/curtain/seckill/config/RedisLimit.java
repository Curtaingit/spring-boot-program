package com.curtain.seckill.config;
...
public class RedisLimit {
    ...
    private RedisLimit(Builder builder) {
        ...
        this.redisConnectionFactory = builder.jedisConnectionFactory;
    ...
    public static class Builder{
        private RedisConnectionFactory jedisConnectionFactory = null ;

        private int limit = 200;
        private int type ;


        public Builder(RedisConnectionFactory jedisConnectionFactory,int type){
